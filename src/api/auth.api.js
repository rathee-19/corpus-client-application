...
export const changePasswordApi = (payload) => apiClient.post('/auth/change-password', payload);
export const resetPasswordApi = (payload) => apiClient.post('/auth/reset-password', payload);
export const sendLoginOtpApi = (payload) => apiClient.post('/auth/login/send-otp', payload);
export const verifyLoginOtpApi = (payload) => apiClient.post('/auth/login/verify-otp', payload);
export const resendLoginOtpApi = (payload) => apiClient.post('/auth/login/resend-otp', payload);
export const sendSignupOtpApi = (payload) => apiClient.post('/auth/signup/send-otp', payload);
export const verifySignupOtpApi = (payload) => apiClient.post('/auth/signup/verify-otp', payload);
